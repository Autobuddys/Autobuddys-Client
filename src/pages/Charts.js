...
export default function Charts() {
  ...
  useEffect(()=>{
    async function getGraphVital() {
      await axiosInstance.get(`elder/graph-dashboard/${patientID}`)
      .then((res)=>{
  ...
  const handleShow = async (item) =>{
    ...
    if(item=="Weekly"){
      await axiosInstance.get(`elder/chart-data/W${patientID}`)
        .then((res)=>{
      ...
      await axiosInstance.get(`elder/chart-data/Y${patientID}`)
        .then((res)=>{
      ...
      await axiosInstance.get(`elder/chart-data/M${patientID}`)
        .then((res)=>{
